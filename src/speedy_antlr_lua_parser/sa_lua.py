...
try:
    from . import sa_lua_cpp_parser
except ImportError:
    warnings.warn("Speedy Antlr failed to load C++ extension")
...
def _cpp_parse(stream:InputStream, entry_rule_name:str, sa_err_listener:SA_ErrorListener=None) -> ParseTree:
    ...
    return sa_lua_cpp_parser.do_parse(LuaParser, stream, entry_rule_name, sa_err_listener)
